...
const bgVariants: Record<NonNullable<ButtonProps["variant"]>, string> = {
...
const activeBgVariants: Record<NonNullable<ButtonProps["variant"]>, string> = {
...
type ButtonVariant = NonNullable<Exclude<ButtonProps["variant"], null>>;
