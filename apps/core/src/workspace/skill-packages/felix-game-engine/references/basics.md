...
## Browser-Native Rendering Choices

- **DOM/CSS** -- Menus, card games, quizzes, boards, and UI-heavy games.
- **SVG** -- Crisp vector maps, puzzles, scalable characters, and diagrams.
- **Canvas 2D** -- Sprites, particles, tilemaps, drawing, and many moving objects.
- **CSS 3D** -- Lightweight depth effects, rotating cards, rooms, and perspective illusions.
- **Raw WebGL** -- Custom 3D geometry and shaders when the idea genuinely needs them.
